          ...
          {status === "error" && (
            <div style={{padding: 28}}>
              ...
              <p style={{color:"#6d655a"}}>
                This usually means the host environment blocks cross-origin requests. Run the component
                in a normal browser dev server, or proxy the NOAA endpoint through your app.
              </p>
            </div>
          )}
